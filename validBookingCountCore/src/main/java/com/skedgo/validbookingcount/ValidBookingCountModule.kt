...
class ValidBookingCountModule {
  @Provides fun validBookingCountApi(okHttpClient: okhttp3.OkHttpClient, gson: Gson): ValidBookingCountApi {
  ...
  @Provides @Named("ValidBookingCountPreferences") fun validBookingCountSharedPreferences(context: Context): SharedPreferences {
