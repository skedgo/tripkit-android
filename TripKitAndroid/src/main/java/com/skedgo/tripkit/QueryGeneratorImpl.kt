...
//                    }
                ...
                if (allTransportModes.contains(TransportMode.ID_WALK) && !allTransportModes.contains(
                ...
                if (departure.locationClass == LOCATION_CLASS_SCHOOL ||
                    ...
                    val modeIdentifiers =
                        (departure.modeIdentifiers.orEmpty() + arrival.modeIdentifiers.orEmpty())
                            .toSet().toList()
    ...
    private val tripRegionResolver: com.skedgo.tripkit.TripRegionResolver by lazy {
        com.skedgo.tripkit.TripRegionResolver.create(
            regionService
        )
    }
}