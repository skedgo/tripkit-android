...
internal class MTaxiBookingResolver(private val isPackageInstalled: Function<String, Boolean>,
                                    private val getAppIntent: Function<String, Intent> ) : com.skedgo.tripkit.bookingproviders.BookingResolver {
