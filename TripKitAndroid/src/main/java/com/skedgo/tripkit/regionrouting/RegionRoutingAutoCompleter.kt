...
interface RegionRoutingAutoCompleter {
    ...
    class RegionRoutingAutoCompleterImpl(
        ...
        override fun getRoutes(regionName: String, query: String): Single<List<RegionRoute>> {
            ...
            return regionRoutingApi.getRegionRoutes("https://api.tripgo.com/v1/info/routes.json", request)
        }
        ...
        override fun getRoutes(query: String, location: Location?): Observable<List<RegionRoute>> {
            return (
                    if (location != null) {
                        ...
                        regionRoutingApi.getRegionRoutes("https://api.tripgo.com/v1/info/routes.json", request)
                    }
        }
        ...
        override fun observe(onNext: (List<RegionRoute>) -> Unit, onError: (Throwable) -> Unit): Disposable =
                regionRouteResult
                        .subscribeOn(Schedulers.io())
                        .observeOn(AndroidSchedulers.mainThread())
                        .subscribe({
    ...
    class AutoCompleteQuery(
        ...
        private constructor(builder: Builder) : this(builder.query, builder.location, builder.regionName)
