...
import com.skedgo.tripkit.BaseUrlOverridingInterceptor;
...
public class BaseUrlOverridingInterceptorTest {
  ...
  @Test public void overrideSatappRequestWithoutQueryParams() throws Exception {
  ...
  @Test public void overrideSatappRequestWithQueryParams() throws Exception {
    when(baseUrlAdapter.call()).thenReturn("https://granduni.buzzhives.com/satapp-beta/");
  ...
  @Test public void ignoreNonTripgoRequest() throws Exception {
    when(baseUrlAdapter.call()).thenReturn("https://granduni.buzzhives.com/satapp-beta/");
  ...
  @Test public void ignoreIfNoNewBaseUrlAvailable() throws Exception {
