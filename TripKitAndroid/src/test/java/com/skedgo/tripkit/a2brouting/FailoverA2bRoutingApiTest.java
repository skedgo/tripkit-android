...
public class FailoverA2bRoutingApiTest {
    ...
    @Test
    public void shouldFailSilentlyIfMissingUrls() {
    ...
    @Test
    public void shouldFailSilentlyIfAllRequestsFail() {
        when(api.execute(
            anyString(),
    ...
    @Test
    public void shouldFailSilentlyIfNoTripGroupsFoundOnAllUrls() {
    ...
    @Test
    public void throwUserErrorWhenRoutingWithMultipleUrls() {
    ...
    @Test
    public void shouldEmitNothingIfHavingErrorAndNotUserError() {
        final RoutingResponse response = mock(RoutingResponse.class);
