...
public class ActionUberStrategy implements ExternalActionStrategy {
  ...
  public ActionUberStrategy(Resources resources, Func1<String, Boolean> isPackageInstalled) {
