...
class OAuth2CallbackHandlerImpl(
    private val externalOAuthService: ExternalOAuthService,
    private val bookingService: BookingService
) : OAuth2CallbackHandler {

    override fun handleOAuthURL(
        ...
        if (code != null) {
            // get access token
            return externalOAuthService.getAccessToken(
                bookingForm,
                code,
                "authorization_code",
                callback
