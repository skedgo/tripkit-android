...
class TripGroupEntityAdapter : SQLiteEntityAdapter<TripGroup> {
  override fun toEntity(cursor: Cursor): TripGroup {
  ...
  override fun toContentValues(group: TripGroup): ContentValues {
