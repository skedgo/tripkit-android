...
public class BookingFormTest {
    ...
    @Test
    public void updateOAuthBookingFormAsync() throws IOException {
    ...
    @Test
    public void shouldBeAuthForm() throws IOException {
    ...
    @Test
    public void shouldBePayiQForm() throws IOException {
    ...
    @Test
    public void shouldBeUberBookingForm() throws Exception {
