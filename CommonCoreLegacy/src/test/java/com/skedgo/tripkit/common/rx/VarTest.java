...
public class VarTest {
    ...
    @Test
    public void shouldEmitDefaultValue() {
    ...
    @Test
    public void valueShouldBeNullIfNoDefaultValue() {
        final Var<String> v = Var.create();
        assertThat(v.value()).isNull();
    }

    @Test
    public void valueShouldReflectLatestValue() {
        final Var<String> v = Var.create();
        v.put("A");
    ...
    @Test
    public void shouldEmitLatestValue() {
        final Var<String> v = Var.create();
    ...
    @Test
    public void shouldNotLeakSubject() {
        final Var<String> v = Var.create();
