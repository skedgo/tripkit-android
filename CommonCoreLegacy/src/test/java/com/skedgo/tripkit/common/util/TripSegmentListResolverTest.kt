...
class TripSegmentListResolverTest {
    ...
    @Test
    fun shouldOnlyShowDepartureSegmentInDetails() {
    ...
    @Test
    fun arrivalSegmentShouldBeVisibleInMap() {
        val segment = TripSegment()
    ...
    @Test
    fun shouldHaveCorrectTimeRangeForArrivalSegment() {
    ...
    @Test
    fun shouldHaveCorrectTimeRangeForDepartureSegment() {
