...
public class TripComparatorsTest {
    ...
    @Test
    public void timeComparatorChain() {
    ...
    @Test
    public void durationComparator() {
    ...
    @Test
    public void moneyCostComparator() {
        {
            final Trip lhs = new Trip();
            lhs.setMoneyCost(5f);
    ...
    @Test
    public void carbonCostComparator() {
        {
            final Trip lhs = new Trip();
    ...
    @Test
    public void shouldCompareLongsCorrectly() {
