...
public abstract class BookingProvider implements Parcelable {
  public static final Creator<BookingProvider> CREATOR = new Creator<BookingProvider>() {
    @Override public BookingProvider createFromParcel(Parcel in) {
    ...
    @Override public BookingProvider[] newArray(int size) {
  ...
  @Nullable public abstract ServiceColor color();
  @Nullable public abstract String name();
  @Nullable public abstract String phone();
  @Nullable public abstract String remoteDarkIcon();
