...
internal class ValidBookingCountRepositoryImpl(
    ...
    override fun getLocalValidBookingCount(): Observable<Int> = Flowable.create<Int>({
    ...
    override fun getRemoteValidBookingCount(): Observable<Int> = api.fetchValidBookingCount()
        .map { it.count() }
        .doOnNext {
            preferences.edit()
