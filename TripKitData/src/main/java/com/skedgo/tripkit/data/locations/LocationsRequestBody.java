...
public final class LocationsRequestBody {
  @SerializedName("region") public final String regionName;
  @SerializedName("cellIDs") public final ArrayList<String> cellIds;
  @SerializedName("level") public final int level;
  @SerializedName("cellIDHashCodes") public final Map<String, Long> existingCells;
  @SerializedName("config") public final JsonObject config;
  @SerializedName("modes") public final List<String> modes;
