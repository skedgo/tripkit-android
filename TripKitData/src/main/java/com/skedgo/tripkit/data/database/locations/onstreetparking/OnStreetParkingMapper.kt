...
open class OnStreetParkingMapper @Inject constructor() {
    ...
    fun toEntity(
        cellId: String,
        onStreetParkingLocations: List<OnStreetParkingLocation>
    ): List<OnStreetParkingEntity> {
        return onStreetParkingLocations.map { toEntity(cellId, it) }
    }

    private fun toEntity(
        cellId: String,
        onStreetParkingLocation: OnStreetParkingLocation
        ...
        entity.availableContent = onStreetParkingLocation.onStreetParking().availableContent()
